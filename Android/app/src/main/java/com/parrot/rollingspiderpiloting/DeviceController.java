...
public class DeviceController implements ARCommandCommonCommonStateBatteryStateChangedListener
{
    ...
    public boolean sendMaxRotationSpeed(float current)
    {
        ARCOMMANDS_GENERATOR_ERROR_ENUM cmdError = ARCOMMANDS_GENERATOR_ERROR_ENUM.ARCOMMANDS_GENERATOR_OK;
        boolean sentStatus = true;
        ARCommand cmd = new ARCommand();
        ...
        if (sentStatus == false)
        {
            ARSALPrint.e(TAG, "Failed to send max rotation speed command.");
        }

        return sentStatus;
    }

    public boolean sendMaxTiltSpeed(float current)
    {
        ARCOMMANDS_GENERATOR_ERROR_ENUM cmdError = ARCOMMANDS_GENERATOR_ERROR_ENUM.ARCOMMANDS_GENERATOR_OK;
        boolean sentStatus = true;
        ARCommand cmd = new ARCommand();
        ...
        if (sentStatus == false)
        {
            ARSALPrint.e(TAG, "Failed to send max tilt speed command.");
        }

        return sentStatus;
    }

    public boolean sendMaxVerticalSpeed(float current)
    {
        ARCOMMANDS_GENERATOR_ERROR_ENUM cmdError = ARCOMMANDS_GENERATOR_ERROR_ENUM.ARCOMMANDS_GENERATOR_OK;
        boolean sentStatus = true;
        ARCommand cmd = new ARCommand();
        ...
        if (sentStatus == false)
        {
            ARSALPrint.e(TAG, "Failed to send max vertical speed command.");
        }

        return sentStatus;
    }

    public boolean sendMaxAltitude(float current)
    {
        ARCOMMANDS_GENERATOR_ERROR_ENUM cmdError = ARCOMMANDS_GENERATOR_ERROR_ENUM.ARCOMMANDS_GENERATOR_OK;
        boolean sentStatus = true;
        ARCommand cmd = new ARCommand();
        ...
        if (sentStatus == false)
        {
            ARSALPrint.e(TAG, "Failed to send max altitude command.");
        }
